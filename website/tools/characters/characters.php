    ...
    while ($row = $sth->fetch()) {
        ...
        if ($row['image'] === "1") {
            echo "<picture class=\"lozad\">
                    <source srcset=\"/images/avif/models/".strtolower($row["categoryname"])."/".strtolower($row["modelname"]).".avif\">
                    <source srcset=\"/images/webp/models/".strtolower($row["categoryname"])."/".strtolower($row["modelname"]).".webp\">
                    <img src=\"/images/webp/models/".strtolower($row["categoryname"])."/".strtolower($row["modelname"]).".webp\" alt=\"\"></noscript>
                </picture>";
        } else {
